function [] = plot_mix(mix,area,nContLines,LineType,min_p,max_p)
% Plot component density contours for 2D mixture model
% FORMAT [] =plot_mix(mix,area,nContLines,LineType,min_p,max_p)
%
...
for j=1:mix.m,
    ...
    if nContLines==1
        [c h] = contour(g1,g2,yplot,[clevels, clevels],LineType);
    else
        [c h] = contour(g1,g2,yplot,clevels,LineType);
    end
    set(h,'linewidth',1);
end
